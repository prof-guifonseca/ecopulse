...
import { ArmorRivets, CircuitLines, EnergyDots, GlassSheen, Leaf, StitchLines, wrapVisual } from './visualPrimitives';
...
function HairVisual(props: GearVisualRenderProps) {
  ...
  if (family === 'akashi' || isTheme(item, 'anime')) {
    return wrapVisual(
      <g>
        <path d="M72 104 C76 72, 94 50, 120 45 C149 40, 169 64, 168 105 C146 86, 104 83, 72 104 Z" fill={palette.dark} />
        <path d="M78 97 L92 49 L106 91 L122 35 L138 91 L158 54 L166 105 C141 79, 103 80, 78 97 Z" fill={palette.primary} />
        <path d="M88 72 L105 91 M137 70 L126 93" stroke={palette.accent} strokeWidth="4.8" strokeLinecap="round" />
        <path d="M100 52 C114 43, 137 46, 151 63" fill="none" stroke={palette.light} strokeWidth="3" strokeLinecap="round" opacity="0.28" />
      </g>,
      props
    );
  }
  ...
  if (family === 'samurai-verde' || itemName(item).includes('topknot')) {
    return wrapVisual(
      <g>
        ...
        <path d="M112 41 C119 36, 130 37, 134 44" fill="none" stroke={palette.light} strokeWidth="2.5" strokeLinecap="round" opacity="0.38" />
      </g>,
      props
    );
  }
  ...
  return wrapVisual(
    <g>
      ...
      <path d="M88 63 C106 47, 137 49, 155 72" fill="none" stroke={palette.primary} strokeWidth="8" strokeLinecap="round" opacity="0.78" />
      <path d="M97 58 C111 52, 136 53, 149 66" fill="none" stroke={palette.light} strokeWidth="3" strokeLinecap="round" opacity="0.34" />
    </g>,
    props
  );
}
...
function HeadVisual(props: GearVisualRenderProps) {
  ...
  if (family === 'cyber-reciclador' || isTheme(item, 'cyber')) return wrapVisual(<CyberHead palette={palette} />, props);
  if (family === 'samurai-verde' || name.includes('kabuto')) return wrapVisual(<SamuraiHead palette={palette} />, props);
  if (family === 'ninja-eco' || name.includes('capuz')) return wrapVisual(<NinjaHead palette={palette} />, props);
  if (family === 'mago-da-floresta') return wrapVisual(<MageHead palette={palette} />, props);
  if (family === 'guardiao-da-floresta' || name.includes('coroa')) return wrapVisual(<GuardianHead palette={palette} />, props);
  if (family === 'pirata-recicla') return wrapVisual(<PirateHead palette={palette} />, props);
  if (family === 'ciclista-verde' || name.includes('capacete')) return wrapVisual(<CyclistHead palette={palette} />, props);
  ...
  return wrapVisual(
    <g>
      ...
      <path d="M90 82 C108 73, 136 73, 153 82" fill="none" stroke={palette.light} strokeWidth="3" opacity="0.45" />
    </g>,
    props
  );
}
...
function CyberHead({ palette }: { palette: AvatarPalette }) {
  return (
    <g>
      ...
      <rect x="60" y="82" width="27" height="36" rx="11" fill={palette.secondary} stroke={palette.accent} strokeWidth="4" />
      <rect x="153" y="82" width="27" height="36" rx="11" fill={palette.secondary} stroke={palette.accent} strokeWidth="4" />
      <path d="M82 75 C101 60, 139 60, 158 75" fill="none" stroke={palette.glow} strokeWidth="4" strokeLinecap="round" opacity="0.8" />
      <path d="M74 100 L60 124 M166 100 L181 124" stroke={palette.glow} strokeWidth="3" strokeLinecap="round" opacity="0.55" />
    </g>
  );
}
...
function SamuraiHead({ palette }: { palette: AvatarPalette }) {
  return (
    <g>
      ...
      <path d="M77 88 C92 75, 148 75, 164 88 L160 101 L81 101 Z" fill={palette.secondary} opacity="0.68" />
...
function NinjaHead({ palette }: { palette: AvatarPalette }) {
  return (
    <g>
      ...
      <path d="M79 117 C86 80, 103 61, 121 60 C142 61, 156 80, 162 117 C140 101, 101 101, 79 117 Z" fill={palette.dark} opacity="0.67" />
      <path d="M77 89 C95 73, 145 73, 163 89" fill="none" stroke={palette.accent} strokeWidth="4" opacity="0.62" />
      <path d="M83 103 C104 96, 137 96, 158 103" fill="none" stroke={palette.light} strokeWidth="2.8" strokeLinecap="round" opacity="0.32" />
    </g>
  );
}
...
function MageHead({ palette }: { palette: AvatarPalette }) {
  return (
    <g>
      ...
      <path d="M83 104 C100 89, 140 89, 157 104" fill="none" stroke={palette.light} strokeWidth="3" opacity="0.36" />
    </g>
  );
}
...
function PirateHead({ palette }: { palette: AvatarPalette }) {
  return (
    <g>
      ...
      <path d="M88 73 C107 66, 140 66, 157 76" fill="none" stroke={palette.light} strokeWidth="3" opacity="0.33" />
    </g>
  );
}
...
function CyclistHead({ palette }: { palette: AvatarPalette }) {
  return (
    <g>
      ...
      <path d="M94 51 L117 90 M137 51 L119 90" stroke={palette.light} strokeWidth="4" opacity="0.56" />
      <path d="M86 82 C104 76, 138 76, 157 82" fill="none" stroke={palette.accent} strokeWidth="3" opacity="0.58" />
    </g>
  );
}
...
function ScientistHead({ palette }: { palette: AvatarPalette }) {
  return (
    <g>
      <path d="M78 84 C86 60, 104 47, 122 47 C142 47, 158 61, 163 84 C141 77, 101 77, 78 84 Z" fill={palette.light} />
      <path d="M81 86 C96 74, 145 74, 160 86" fill="none" stroke={palette.secondary} strokeWidth="5" strokeLinecap="round" />
...
function ExplorerHead({ palette }: { palette: AvatarPalette }) {
  return (
    <g>
      <path d="M78 84 C90 58, 143 57, 164 84 L158 95 C137 87, 104 87, 82 95 Z" fill={palette.primary} />
      <path d="M70 88 C92 82, 150 82, 172 88" stroke={palette.accent} strokeWidth="8" strokeLinecap="round" />
...
function CapoeiraHead({ palette }: { palette: AvatarPalette }) {
  return (
    <g>
      <path d="M77 91 C93 79, 147 79, 163 91" fill="none" stroke={palette.secondary} strokeWidth="11" strokeLinecap="round" />
...
function FaceVisual(props: GearVisualRenderProps) {
  ...
  if (family === 'cyber-reciclador' || isTheme(item, 'cyber') || name.includes('visor')) {
    return wrapVisual(
      <g>
        <path d="M76 113 C91 103, 149 103, 164 113 L160 135 C141 144, 99 144, 81 135 Z" fill={palette.dark} opacity="0.92" />
  ...
  if (family === 'ninja-eco' || name.includes('mascara') || name.includes('máscara')) {
    return wrapVisual(
      <g>
        <path d="M77 113 C98 102, 143 102, 164 113 L160 143 C141 154, 102 154, 81 143 Z" fill={palette.dark} opacity="0.96" />
        ...
        <path d="M91 136 C109 142, 132 142, 150 136" stroke={palette.accent} strokeWidth="3" strokeLinecap="round" opacity="0.58" />
      </g>,
      props
    );
  }
  ...
  if (family === 'guardiao-da-floresta') {
    return wrapVisual(
      <g>
        <path d="M93 119 C103 109, 112 110, 119 121 C110 124, 101 126, 93 119 Z" fill={palette.accent} opacity="0.82" />
        <path d="M147 119 C137 109, 128 110, 121 121 C130 124, 139 126, 147 119 Z" fill={palette.accent} opacity="0.82" />
  ...
  if (family === 'cientista-eco' || name.includes('oculos') || name.includes('óculos')) {
    return wrapVisual(
      <g>
        <rect x="82" y="111" width="34" height="22" rx="9" fill="rgba(9,20,18,0.42)" stroke={palette.accent} strokeWidth="4" />
        <rect x="125" y="111" width="34" height="22" rx="9" fill="rgba(9,20,18,0.42)" stroke={palette.accent} strokeWidth="4" />
...
function TorsoVisual(props: GearVisualRenderProps) {
  ...
  if (family === 'cyber-reciclador' || isTheme(item, 'cyber')) return wrapVisual(<CyberTorso palette={palette} />, props);
  if (family === 'samurai-verde' || isTheme(item, 'samurai')) return wrapVisual(<SamuraiTorso palette={palette} />, props);
  ...
  if (family === 'guardiao-da-floresta') return wrapVisual(<GuardianTorso palette={palette} />, props);
...
function CyberTorso({ palette }: { palette: AvatarPalette }) {
  return (
    <g>
      ...
      <path d="M82 145 L101 136 L120 179 L139 136 L158 145 L162 223 L78 223 Z" fill={palette.secondary} opacity="0.92" />
...
function SamuraiTorso({ palette }: { palette: AvatarPalette }) {
  return (
    <g>
      ...
      <path d="M78 166 L162 166 M80 186 L160 186 M84 207 L156 207" stroke={palette.accent} strokeWidth="7" opacity="0.8" />
      <path d="M92 137 L120 177 L148 137" fill="none" stroke={palette.light} strokeWidth="5" opacity="0.45" />
...
function NinjaTorso({ palette }: { palette: AvatarPalette }) {
  return (
    <g>
      ...
      <path d="M84 201 C101 209, 139 209, 156 201" stroke={palette.light} strokeWidth="4" opacity="0.42" />
    </g>
  );
}
...
function MageTorso({ palette }: { palette: AvatarPalette }) {
  return (
    <g>
      ...
      <path d="M95 131 C104 166, 110 207, 108 258 L132 258 C130 207, 137 166, 146 131" fill={palette.secondary} opacity="0.74" />
      <path d="M86 162 C102 172, 138 172, 154 162" stroke={palette.accent} strokeWidth="5" strokeLinecap="round" opacity="0.78" />
      <circle cx="120" cy="181" r="11" fill={palette.accent} />
      <path d="M120 168 L120 194 M107 181 L133 181" stroke={palette.dark} strokeWidth="3" strokeLinecap="round" opacity="0.58" />
...
function GuardianTorso({ palette }: { palette: AvatarPalette }) {
  return (
    <g>
      ...
      <path d="M87 157 C66 151, 56 139, 51 123 C70 132, 84 135, 100 137" fill={palette.accent} opacity="0.9" />
      <path d="M153 157 C174 151, 184 139, 189 123 C170 132, 156 135, 140 137" fill={palette.accent} opacity="0.9" />
      <path d="M96 156 C106 184, 103 209, 91 230 M144 156 C134 184, 137 209, 149 230" stroke={palette.dark} strokeWidth="5" strokeLinecap="round" opacity="0.64" />
...
function ScientistTorso({ palette }: { palette: AvatarPalette }) {
  return (
    <g>
      ...
      <path d="M92 196 H114 M92 207 H111" stroke={palette.secondary} strokeWidth="3" strokeLinecap="round" opacity="0.55" />
    </g>
  );
}
...
function CapoeiraTorso({ palette }: { palette: AvatarPalette }) {
  return (
    <g>
      ...
      <path d="M88 208 C104 216, 136 216, 152 208" stroke={palette.secondary} strokeWidth="4" strokeLinecap="round" opacity="0.5" />
    </g>
  );
}
...
function ExplorerTorso({ palette }: { palette: AvatarPalette }) {
  return (
    <g>
      <path d="M66 174 C76 142, 95 128, 120 128 C146 128, 165 142, 174 174 L166 241 C140 254, 100 254, 74 241 Z" fill={palette.primary} />
      <path d="M86 145 L106 135 L120 177 L134 135 L154 145 L151 228 L89 228 Z" fill={palette.secondary} opacity="0.88" />
...
function LegsVisual(props: GearVisualRenderProps) {
  ...
  if (family === 'samurai-verde') {
    return wrapVisual(
      <g>
        ...
        <path d="M81 241 L112 241 M128 241 L160 241 M84 262 L110 262 M130 262 L158 262" stroke={palette.accent} strokeWidth="4" opacity="0.45" />
      </g>,
      props
    );
  }
  ...
  if (family === 'ninja-eco' || family === 'cyber-reciclador') {
    return wrapVisual(
      <g>
        ...
        <path d="M90 247 L106 247 M134 247 L152 247" stroke={palette.accent} strokeWidth="4" opacity="0.65" />
        {family === 'cyber-reciclador' ? <path d="M94 229 L103 286 M146 229 L137 286" stroke={palette.glow} strokeWidth="3" opacity="0.5" /> : null}
      </g>,
      props
    );
  }
  ...
  if (family === 'mago-da-floresta') {
    return wrapVisual(
      <g>
        <path d="M78 222 C94 236, 146 236, 163 222 L156 294 L84 294 Z" fill={palette.secondary} opacity="0.94" />
        <path d="M98 240 C111 249, 131 249, 144 240" stroke={palette.accent} strokeWidth="4" strokeLinecap="round" opacity="0.55" />
      </g>,
      props
    );
  }
  ...
  if (family === 'guardiao-da-floresta') {
    return wrapVisual(
      <g>
        ...
        <path d="M89 237 C100 248, 100 266, 86 288 M151 237 C140 248, 140 266, 154 288" stroke={palette.accent} strokeWidth="5" strokeLinecap="round" opacity="0.58" />
      </g>,
      props
    );
  }
  ...
  return wrapVisual(
    <g>
      ...
      <path d="M86 248 L108 248 M132 248 L154 248" stroke={palette.accent} strokeWidth="4" opacity="0.48" />
    </g>,
    props
  );
}
  ...
  return wrapVisual(
    <g>
      ...
      <path
        ...
        fill={sandal ? palette.primary : palette.dark}
      />
      <path d="M77 295 L107 295 M133 295 L163 295" stroke={palette.light} strokeWidth="3" opacity="0.66" />
      {family === 'cyber-reciclador' ? <path d="M82 300 H110 M132 300 H160" stroke={palette.glow} strokeWidth="4" strokeLinecap="round" opacity="0.82" /> : null}
      {sandal ? <path d="M78 289 L108 301 M132 301 L164 289" stroke={palette.accent} strokeWidth="3" opacity="0.62" /> : null}
    </g>,
    props
  );
}
...
function BackVisual(props: GearVisualRenderProps) {
  ...
  if (family === 'cyber-reciclador') {
    return wrapVisual(
      <g>
        ...
        <path d="M155 170 C133 154, 108 154, 85 171" fill="none" stroke={palette.dark} strokeWidth="7" opacity="0.5" />
        <path d="M165 144 H184 M165 199 H184" stroke={palette.light} strokeWidth="3" strokeLinecap="round" opacity="0.45" />
      </g>,
      props
    );
  }
  ...
  if (family === 'mago-da-floresta' || family === 'guardiao-da-floresta') {
    return wrapVisual(
      <g>
        <path d="M63 126 C41 169, 42 254, 75 299 C94 278, 146 278, 166 299 C199 254, 199 169, 177 126 Z" fill={palette.secondary} opacity="0.9" />
        <path d="M82 146 C73 194, 79 244, 99 282 M158 146 C167 194, 161 244, 141 282" stroke={palette.accent} strokeWidth="4" strokeLinecap="round" opacity="0.52" />
  ...
  if (family === 'ciclista-verde') {
    return wrapVisual(
      <g>
        ...
        <path d="M163 171 H188" stroke={palette.glow} strokeWidth="3" strokeLinecap="round" opacity="0.6" />
      </g>,
      props
    );
  }
  ...
  return wrapVisual(
    <g>
      ...
      <path d="M158 170 C133 155, 107 155, 82 170" fill="none" stroke={palette.dark} strokeWidth="7" opacity="0.58" />
      <path d="M165 206 H186" stroke={palette.accent} strokeWidth="3" strokeLinecap="round" opacity="0.52" />
    </g>,
    props
  );
}
...
function HandVisual(props: GearVisualRenderProps) {
  ...
  if (name.includes('shuriken')) return wrapVisual(<ThrownStar x={x} y={y} dir={dir} palette={palette} pose={pose} />, props);
  if (name.includes('katana') || name.includes('lamina') || name.includes('lâmina')) return wrapVisual(<Blade x={x} y={y} dir={dir} palette={palette} pose={pose} />, props);
  if (name.includes('machado')) return wrapVisual(<Axe x={x} y={y} dir={dir} palette={palette} />, props);
  if (name.includes('gancho')) return wrapVisual(<Hook x={x} y={y} dir={dir} palette={palette} />, props);
  if (name.includes('cajado') || name.includes('bo') || name.includes('berimbau')) return wrapVisual(<Staff x={x} y={y} dir={dir} palette={palette} name={name} />, props);
  if (family === 'cyber-reciclador' || name.includes('scanner') || name.includes('coletor')) return wrapVisual(<ScannerTool x={x} y={y} dir={dir} palette={palette} />, props);
  if (name.includes('mapa') || name.includes('bequer') || name.includes('béquer') || name.includes('garrafa')) return wrapVisual(<ObjectTool x={x} y={y} dir={dir} palette={palette} name={name} />, props);
  if (name.includes('ginga')) return wrapVisual(<GingaArc x={x} y={y} dir={dir} palette={palette} />, props);
...
function ScannerTool({ x, y, dir, palette }: ToolProps) {
  return (
    <g transform={`translate(${x} ${y}) rotate(${dir * 9})`}>
      ...
      <path d="M-21 -12 H21" stroke={palette.light} strokeWidth="4" strokeLinecap="round" opacity="0.65" />
      <path d="M-7 -21 H7 M-7 -15 H7" stroke={palette.dark} strokeWidth="2" strokeLinecap="round" opacity="0.55" />
    </g>
  );
}
    ...
    <g transform={`translate(${x} ${y}) rotate(${dir * -8})`}>
      {name.includes('mapa') ? (
        <g>
          ...
          <path d="M-12 -11 C-3 -19, 9 -18, 15 -7 M-9 12 C2 3, 10 8, 17 0" fill="none" stroke={palette.secondary} strokeWidth="3" strokeLinecap="round" opacity="0.72" />
        </g>
      ) : (
        <g>
          <path d="M-12 -36 L12 -36 L8 22 C5 34,-5 34,-8 22 Z" fill={palette.accent} opacity="0.86" stroke={palette.light} strokeWidth="4" />
          <path d="M-6 4 C-1 -1, 4 0, 8 5" fill="none" stroke={palette.dark} strokeWidth="2" opacity="0.45" />
        </g>
      )}
    </g>
  );
...
function ThrownStar({ x, y, dir, palette, pose }: ToolProps) {
  return (
    <g transform={`translate(${pose === 'attack' ? x + dir * 12 : x} ${pose === 'attack' ? y - 28 : y}) rotate(${dir * 24})`}>
      <path d="M0 -34 L8 -9 L34 0 L8 9 L0 34 L-8 9 L-34 0 L-8 -9 Z" fill={palette.accent} />
      <circle cx="0" cy="0" r="8" fill={palette.dark} />
      <path d="M-22 -22 L22 22 M22 -22 L-22 22" stroke={palette.light} strokeWidth="3" opacity="0.5" />
    </g>
  );
}
...
function GingaArc({ x, y, dir, palette }: ToolProps) {
  return (
    <g transform={`translate(${x} ${y}) scale(${dir} 1)`}>
      <path d="M-29 -6 C-7 -38, 31 -35, 43 -2 C26 16, -4 19, -29 -6 Z" fill="none" stroke={palette.accent} strokeWidth="7" strokeLinecap="round" />
      <path d="M-18 0 C5 -17, 21 -15, 34 2" fill="none" stroke={palette.light} strokeWidth="3" strokeLinecap="round" opacity="0.58" />
    </g>
  );
}
  ...
  return wrapVisual(
    <g opacity={level >= 3 ? 0.95 : 0.82}>
      ...
      <ellipse
        ...
        strokeDasharray={circuit ? '10 11' : forest ? '3 12' : rhythm ? '20 10' : cloud ? '2 10' : undefined}
        opacity="0.74"
      />
...
function ForestAura({ palette }: { palette: AvatarPalette }) {
  return (
    <g>
      ...
      <path d="M69 267 C87 248, 104 246, 120 263 C137 246, 154 248, 171 267" fill="none" stroke={palette.accent} strokeWidth="4" strokeLinecap="round" opacity="0.55" />
    </g>
  );
}
...
function RhythmAura({ palette }: { palette: AvatarPalette }) {
  return (
    <g fill="none" strokeLinecap="round">
      <path d="M53 205 C75 177, 101 170, 123 181" stroke={palette.accent} strokeWidth="4" opacity="0.68" />
      <path d="M187 147 C165 176, 137 182, 116 169" stroke={palette.secondary} strokeWidth="4" opacity="0.62" />
    </g>
  );
}
